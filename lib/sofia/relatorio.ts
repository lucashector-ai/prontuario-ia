...
<body style="font-family:-apple-system,BlinkMacSystemFont,sans-serif;background:#F9FAFC;padding:20px;margin:0">
  <div style="max-width:600px;margin:0 auto;background:white;border-radius:12px;overflow:hidden;border:1px solid #f3f4f6">
    ...
    <div style="padding:16px 24px;background:#fafafa;font-size:11px;color:#9ca3af;text-align:center">
