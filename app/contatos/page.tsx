...
export default function Contatos() {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', background: '#F5F5F5', overflow: 'hidden', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
                ...
                return (
                  <div key={c.id} style={{ background: 'white', borderRadius: 12, padding: 16, cursor: 'pointer', transition: 'box-shadow 0.15s' }}
                    ...
                    <div style={{ display: 'flex', gap: 8, marginTop: 12, flexWrap: 'wrap' }}>
                      ...
                      <span style={{ fontSize: 11, padding: '2px 8px', borderRadius: 20, background: '#F5F5F5', color: '#6b7280' }}>{totalMsgs} msgs</span>
                    </div>
                  </div>
                )
              })}
