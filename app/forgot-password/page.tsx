      ...
      <div style={{ background: 'white', borderRadius: 16, border: '1px solid #f0f0f0', padding: '40px 36px', width: '100%', maxWidth: 380 }}>
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          <div style={{ width: 48, height: 48, background: '#f0ebff', borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 12px' }}>
            <svg width="22" height="22" fill="none" stroke="#1F9D5C" strokeWidth="2" viewBox="0 0 24 24">
        ...
        {enviado ? (
          <div style={{ textAlign: 'center' }}>
            ...
            <Link href="/login" style={{ color: '#1F9D5C', fontSize: 14, textDecoration: 'none' }}>← Voltar ao login</Link>
          </div>
        ) : (
          <>
            ...
            <button onClick={enviar} disabled={loading}
              style={{ width: '100%', padding: 14, borderRadius: 10, border: 'none', cursor: 'pointer', background: loading ? '#b9a9ef' : '#1F9D5C', color: 'white', fontSize: 15, fontWeight: 700, marginBottom: 12 }}>
