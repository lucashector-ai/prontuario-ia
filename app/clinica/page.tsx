      ...
      <main style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        ...
        <div style={{ flex: 1, overflow: "auto", padding: "0 24px 24px", display: "flex", flexDirection: "column", gap: 16, maxWidth: 900 }}>
          ...
          <div style={{ background: "white", borderRadius: 14, overflow: "hidden" }}>
            <div style={{ padding: "14px 20px", borderBottom: "1px solid #FAFAFA" }}>
            ...
            {medicos.map((m, i) => {
              ...
              return (
                <div key={m.id} style={{ padding: "14px 20px", borderBottom: i < medicos.length - 1 ? "1px solid #FAFAFA" : "none", display: "flex", alignItems: "center", gap: 12 }}>
