...
export default function Dicionario() {
  ...
  const bgCategoria: Record<string, string> = {
    ...
    'Anatomia': '#f0fdf4', 'Sigla': '#fffbeb', 'Outro': '#FAFAFA'
  }
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        <div style={{ flex: 1, overflow: 'auto', padding: 24, display: 'grid', gridTemplateColumns: '340px 1fr', gap: 20, alignContent: 'start' }}>
          ...
          <div style={{ background: 'white', borderRadius: 12, padding: 20, height: 'fit-content' }}>
            ...
            <div style={{ marginTop: 20, padding: '12px 14px', background: '#FAFAFA', borderRadius: 8 }}>
                  ...
                  <div key={t.id} style={{ background: 'white', borderRadius: 10, padding: '12px 14px', display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 8 }}>
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 4 }}>
                        ...
                        <span style={{ fontSize: 10, fontWeight: 600, color: corCategoria[t.categoria] || '#6b7280', background: bgCategoria[t.categoria] || '#FAFAFA', padding: '1px 6px', borderRadius: 8, flexShrink: 0 }}>{t.categoria}</span>
                      </div>
