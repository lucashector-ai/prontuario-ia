      ...
      <main style={{ flex: 1, display: 'flex', overflow: 'hidden', flexDirection: 'column', padding: '16px 16px 16px 0' }}>
            ...
            <div style={{ maxWidth: 720 }}>
              <div style={{ background: 'white', borderRadius: 14, overflow: 'hidden' }}>
                ...
                <div style={{ padding: '18px 20px' }}>
                  ...
                  <div style={{ background: '#F5F5F5', border: '1px solid #d4c9f7', borderRadius: 9, padding: '10px 14px', margin: '14px 0' }}>
            ...
            <div style={{ maxWidth: 680 }}>
              ...
              <div style={{ background: 'white', borderRadius: 14, overflow: 'hidden' }}>
                ...
                <form onSubmit={adicionarAtendente} style={{ padding: '16px 20px', display: 'flex', flexDirection: 'column', gap: 12 }}>
                  ...
                  {atMsg && <div style={{ background: atMsg.tipo === 'ok' ? '#F5F5F5' : '#fef2f2', border: '1px solid ' + (atMsg.tipo === 'ok' ? '#d4c9f7' : '#fecaca'), borderRadius: 8, padding: '8px 12px' }}><p style={{ fontSize: 12, color: atMsg.tipo === 'ok' ? '#6043C1' : '#dc2626', margin: 0 }}>{atMsg.texto}</p></div>}
        ...
        {aba === 'configuracao' && (
          <div style={{ flex: 1, overflow: 'auto', padding: 24 }}>
            <div style={{ maxWidth: 680 }}>
              {config && (
                <div style={{ background: '#F5F5F5', border: '1px solid #d4c9f7', borderRadius: 12, padding: '12px 16px', marginBottom: 18, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
