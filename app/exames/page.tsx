...
export default function Exames() {
  ...
  const statusCor = (s: string) => {
    ...
    return { bg: '#F5F5F5', border: '#b9a9ef', text: '#6043C1', badge: '#6043C1', badgeBg: '#F5F5F5' }
  }
        ...
        <div style={{ flex: 1, overflow: 'auto', padding: 24, display: 'grid', gridTemplateColumns: analise ? '1fr 1fr' : '1fr', gap: 20 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div
              ...
              style={{
                background: 'white', border: `2px dashed ${preview ? '#b9a9ef' : '#e5e7eb'}`,
            ...
            <button onClick={handleAnalisar} disabled={!imagem || analisando} style={{
              ...
              background: !imagem ? '#f3f4f6' : analisando ? '#b9a9ef' : '#6043C1',
