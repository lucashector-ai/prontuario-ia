  ...
  try {
    ...
    const secao = (label: string, content: string) => content ? `
      <div style="margin-bottom:20px">
        ...
        <div style="font-size:13px;line-height:1.8;color:#111827;white-space:pre-wrap;background:#FAFAFA;border-radius:8px;padding:12px 14px;border:1px solid #e5e7eb">${content}</div>
      </div>` : ''
...
.meta-card{background:#FAFAFA;border:1px solid #e5e7eb;border-radius:8px;padding:12px 14px}
