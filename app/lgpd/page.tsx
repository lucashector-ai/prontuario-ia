          ...
          <Card>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginTop: 16 }}>
              {[
                ...
                <div key={d.titulo} style={{ background: '#f9fafb', borderRadius: 10, padding: 14 }}>
          ...
          <Card>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {[
                ...
                <div key={item.label} style={{ display: 'flex', alignItems: 'flex-start', gap: 12, padding: '10px 14px', background: '#f9fafb', borderRadius: 8 }}>
