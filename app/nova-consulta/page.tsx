...
export default function Home() {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', background: '#EAECEF' }}>
                ...
                <div style={{ marginTop: 4, borderRadius: 8, overflow: 'hidden', maxHeight: 200, overflowY: 'auto' }}>
                  {pacientes.filter(p => p.nome.toLowerCase().includes(buscaPaciente.toLowerCase())).length === 0 ? (
                    ...
                    <div key={p.id}
                      ...
                      style={{ padding: '10px 14px', cursor: 'pointer', borderBottom: '1px solid #EAECEF', background: 'white' }}
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', padding: '20px 20px 20px 0' }}>
        ...
        {/* Content */}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', overflow: 'hidden', background: '#EAECEF' }}>
                  ...
                  {aba === 'prontuario' && (
                    <>
                      ...
                      <button onClick={handleGerarReceita} disabled={gerandoReceita} style={{
                        ...
                        border: '1px dashed #d1d5db', background: '#EAECEF',
                  ...
                  {aba === 'documentos' && (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                      <div style={{ background: 'white', borderRadius: 12, padding: '16px' }}>
                        ...
                        {!exames ? (
                          <button onClick={handleGerarExames} disabled={gerandoDoc} style={{ width: '100%', padding: '10px', borderRadius: 8, border: '1px dashed #d1d5db', background: '#EAECEF', color: '#6b7280', fontSize: 12, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 7 }}>
                            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                          ...
                          <div>
                            {exames.exames?.map((e: any, i: number) => (
                              <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', padding: '8px 0', borderBottom: '1px solid #EAECEF' }}>
                                <div>
                      ...
                      <div style={{ background: 'white', borderRadius: 12, padding: '16px' }}>
                        ...
                        {!atestado ? (
                          <button onClick={handleGerarAtestado} disabled={gerandoDoc} style={{ width: '100%', padding: '10px', borderRadius: 8, border: '1px dashed #d1d5db', background: '#EAECEF', color: '#6b7280', fontSize: 12, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 7 }}>
                          ...
                          <div>
                            <div style={{ background: '#EAECEF', borderRadius: 8, padding: '12px', marginBottom: 12, fontSize: 13, color: '#374151', lineHeight: 1.7 }}>
