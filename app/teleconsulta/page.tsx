...
export default function Teleconsulta() {
  ...
  const enviarWpp = async (consulta: any) => {
    ...
    const msg = 'Olá! Dr(a). ' + medico.nome + ' te convidou para uma teleconsulta.\n\nAcesse pelo link (não precisa instalar nada):\n' + link
  ...
  return (
    <main style={{ height: '100%', overflow: 'auto', padding: 24, background: BG }}>
      ...
      {/* 2 cards de ação grandes — ocupam toda a largura */}
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 20 }}>
        {/* Card Nova consulta agora */}
        <button
          onClick={criarAgora}
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ fontSize: 13, margin: 0, opacity: 0.9, lineHeight: 1.5 }}>
              Cria sala, copia o link automaticamente e abre em nova aba pra você entrar
            </p>
          </div>
        </button>
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            <p style={{ fontSize: 17, fontWeight: 700, margin: '0 0 4px' }}>Agendar teleconsulta</p>
            <p style={{ fontSize: 13, color: '#6b7280', margin: 0, lineHeight: 1.5 }}>
              Programa uma sala no calendário e envia o link pro paciente no horário
            </p>
          </div>
        </button>
      </div>

      {/* Banner de confirmação quando acabou de criar */}
      {linkCopiado && (
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <p style={{ fontSize: 12, color: ACCENT, margin: 0, opacity: 0.8 }}>
              Link copiado e sala aberta em nova aba — cole no WhatsApp do paciente.
            </p>
          </div>
          <code style={{
            ...
            maxWidth: 320, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' as const,
      ...
      {consultas.length === 0 ? (
        <div style={{
          ...
          <p style={{ fontSize: 13, color: '#9ca3af', margin: 0 }}>
            Crie uma consulta nos cards acima pra começar
          </p>
        </div>
      ) : (
