    ...
    <div style={{ display: 'flex', height: '100vh', background: '#F5F5F5', overflow: 'hidden' }}>
      <main style={{ flex: 1, overflow: 'auto' }}>
        <div style={{ maxWidth: 720, margin: '0 auto' }}>
          ...
          <div style={{ position: 'sticky', bottom: 0, padding: '16px 0', background: '#F5F5F5', borderTop: '1px solid #f3f4f6', marginTop: 20, display: 'flex', justifyContent: 'flex-end', gap: 10 }}>
