    ...
    <div style={{ display: 'flex', height: '100vh', background: '#F5F5F5', overflow: 'hidden' }}>
      <main style={{ flex: 1, overflow: 'auto', padding: 32 }}>
        <div style={{ maxWidth: 680 }}>
          ...
          {/* Status atual */}
          {config && (
            <div style={{ background: '#F5F5F5', border: '1px solid #b9a9ef', borderRadius: 12, padding: '16px 20px', marginBottom: 24, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ background: 'white', borderRadius: 14, overflow: 'hidden', marginBottom: 24 }}>
            ...
            <form onSubmit={salvar} style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              {msg && (
                <div style={{ background: msg.tipo === 'ok' ? '#F5F5F5' : '#fef2f2', border: '1px solid ' + (msg.tipo === 'ok' ? '#b9a9ef' : '#fecaca'), borderRadius: 9, padding: '10px 14px' }}>
