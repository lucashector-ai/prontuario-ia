    ...
    <div style={{ display: 'flex', height: '100vh', background: '#FAFAFA', overflow: 'hidden' }}>
      <main style={{ flex: 1, overflow: 'auto', padding: 32 }}>
        <div style={{ maxWidth: 680 }}>
          ...
          {/* Status atual */}
          {config && (
            <div style={{ background: '#FAFAFA', border: '1px solid #d4c9f7', borderRadius: 12, padding: '16px 20px', marginBottom: 24, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ background: 'white', borderRadius: 14, overflow: 'hidden', marginBottom: 24 }}>
            ...
            <form onSubmit={salvar} style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              {msg && (
                <div style={{ background: msg.tipo === 'ok' ? '#FAFAFA' : '#fef2f2', border: '1px solid ' + (msg.tipo === 'ok' ? '#d4c9f7' : '#fecaca'), borderRadius: 9, padding: '10px 14px' }}>
                ...
                {[
                  ...
                  <div key={item.label}>
                    ...
                    <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                      <code style={{ flex: 1, padding: '8px 12px', background: '#FAFAFA', borderRadius: 7, fontSize: 12, color: '#374151', fontFamily: 'monospace' }}>{item.valor}</code>
