    ...
    <div style={{ display: 'flex', height: '100vh', background: '#f9fafb', overflow: 'hidden' }}>
      ...
      <main style={{ flex: 1, overflow: 'auto', padding: 32 }}>
        <div style={{ maxWidth: 680 }}>
          ...
          {/* Status atual */}
          {config && (
            <div style={{ background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: 12, padding: '16px 20px', marginBottom: 24, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ background: 'white', border: '1px solid #e5e7eb', borderRadius: 14, overflow: 'hidden', marginBottom: 24 }}>
            ...
            <form onSubmit={salvar} style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              {msg && (
                <div style={{ background: msg.tipo === 'ok' ? '#f0fdf4' : '#fef2f2', border: '1px solid ' + (msg.tipo === 'ok' ? '#bbf7d0' : '#fecaca'), borderRadius: 9, padding: '10px 14px' }}>
                  <p style={{ fontSize: 13, color: msg.tipo === 'ok' ? '#166534' : '#dc2626', margin: 0 }}>{msg.texto}</p>
                </div>
              )}
              <button type="submit" disabled={salvando} style={{ padding: '11px', borderRadius: 9, border: 'none', background: salvando ? '#86efac' : '#16a34a', color: 'white', fontSize: 14, fontWeight: 700, cursor: 'pointer' }}>
            ...
            <div style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: 14 }}>
              {[
                ...
                <div key={s.n} style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                  <div style={{ width: 22, height: 22, borderRadius: '50%', background: '#16a34a', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 11, fontWeight: 800, color: 'white', flexShrink: 0, marginTop: 1 }}>{s.n}</div>
