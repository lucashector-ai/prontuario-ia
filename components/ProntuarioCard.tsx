...
const secoes = [
  ...
  { key: 'plano',     letra: 'P', titulo: 'Plano',      sub: 'Conduta e prescrição', cor: '#6043C1', bg: '#ede9fb', border: '#b9a9ef' },
]
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            {prontuario.cids.map((cid, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 10, background: 'white', borderRadius: 8, padding: '8px 10px' }}>
                <span style={{ fontFamily: 'monospace', fontSize: 11, fontWeight: 700, color: '#6043C1', background: '#ede9fb', padding: '2px 8px', borderRadius: 5, flexShrink: 0 }}>{cid.codigo}</span>
                <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
        ...
        <button onClick={handleExportarPDF} style={{
          padding: '9px', borderRadius: 8, background: '#ede9fb',
