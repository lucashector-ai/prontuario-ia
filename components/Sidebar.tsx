...
export function Sidebar() {
  ...
  const grupos = [
    ...
    },
    {
      ...
      items: [
        ...(isAdmin ? [
          { href: '/lgpd', label: 'Privacidade & LGPD', icon: <svg width='16' height='16' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='1.8'><path d='M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z'/></svg> },
          { href: '/minha-clinica', label: 'Minha clínica', icon: <svg width='16' height='16' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2'><path d='M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z'/><polyline points='9 22 9 12 15 12 15 22'/></svg> },
          { href: '/configuracoes/sofia', label: 'Sofia · IA', icon: <svg width='16' height='16' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2'><path d='M12 8V4H8'/><rect x='4' y='12' width='16' height='8' rx='2'/><path d='M2 14h2M20 14h2M15 13v2M9 13v2'/></svg> },
  ...
  return (
    <aside style={{
      ...
      <nav style={{ padding: '8px 12px', flex: 1, overflow: 'auto' }}>
        ...
        {/* Chat IA — destaque no final */}
        {isAdmin && (
          <>
            <div style={{ height: 1, background: '#f0f0f0', margin: '14px 4px 16px' }} />
            <button
              onClick={() => window.location.href = '/whatsapp-app'}
              style={{
                display: 'flex', alignItems: 'center', gap: 10,
