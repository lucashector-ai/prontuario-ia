...
export function Sidebar() {
  ...
  const grupos = [
    ...
    },
    {
      label: 'Ferramentas',
      items: [
        ...(medico?.cargo === 'admin' ? [{ href: '/clinica', label: 'Minha clínica', icon: <svg width='16' height='16' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2'><path d='M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z'/><polyline points='9 22 9 12 15 12 15 22'/></svg> }] : []),
        ...
        ...(!isRecepcionista ? [
          ...
          ...(medico?.cargo === 'admin' ? [
            { href: '/insights', label: 'Insights', icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M18 20V10M12 20V4M6 20v-6"/></svg> },
          ...
          ...(medico?.cargo === 'admin' ? [{ href: '/admin', label: 'Painel admin', icon: <svg width='16' height='16' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2'><path d='M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2'/><circle cx='9' cy='7' r='4'/><path d='M23 21v-2a4 4 0 00-3-3.87'/><path d='M16 3.13a4 4 0 010 7.75'/></svg> }] : []),
